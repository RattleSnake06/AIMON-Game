...
const MOVES = {
  ...
  hyperfang: { name: 'HYPER FANG', type: 'normal', cat: 'physical', power: 80, acc: 90, pp: 15, flinch: 10, fx: 'bite',
    desc: 'Sharp front fangs. May make the foe flinch.' },
  ...
  screech: { name: 'SCREECH', type: 'sound', cat: 'status', acc: 85, pp: 40, fx: 'sound',
    stat: { target: 'foe', stat: 'def', stages: -2 }, desc: 'An earsplitting screech. Sharply lowers DEFENSE.' },
  ...
  magicalleaf: { name: 'MAGICAL LEAF', type: 'grass', cat: 'special', power: 60, acc: 0, pp: 20, fx: 'leaf',
    desc: 'Curious leaves chase the foe. Never misses.' },
  ...
  seedbomb: { name: 'SEED BOMB', type: 'grass', cat: 'physical', power: 80, acc: 100, pp: 15, fx: 'rock',
    desc: 'Pelts the foe with hard-shelled seeds.' },
  ...
  whirlpool: { name: 'WHIRLPOOL', type: 'water', cat: 'special', power: 35, acc: 90, pp: 15, fx: 'water',
    stat: { target: 'foe', stat: 'spe', stages: -1, chance: 100 }, desc: 'A swirling whirlpool that lowers SPEED.' },
  ...
  thunderfang: { name: 'THUNDER FANG', type: 'electric', cat: 'physical', power: 65, acc: 95, pp: 15, flinch: 10, fx: 'bite',
    inflict: { status: 'par', chance: 10 }, desc: 'Electric fangs. May paralyze or flinch.' },
  ...
  bulkup: { name: 'BULK UP', type: 'fighting', cat: 'status', pp: 20, fx: 'glow',
    ...
    desc: 'Tenses up to raise ATTACK and DEFENSE.' },
  ...
  nightshade: { name: 'NIGHT SHADE', type: 'ghost', cat: 'special', power: 1, fixed: 'level', acc: 100, pp: 15, fx: 'ghost',
    desc: 'A mirage that deals damage equal to level.' },
  hex: { name: 'HEX', type: 'ghost', cat: 'special', power: 65, acc: 100, pp: 10, hexed: true, fx: 'ghost',
    desc: 'A curse. Double power if the foe has a status.' },
  ...
  echoedvoice: { name: 'ECHOED VOICE', type: 'sound', cat: 'special', power: 40, acc: 100, pp: 15, fx: 'wave',
    desc: 'An echoing cry. Grows stronger in a row.' },
  ...
  boomburst: { name: 'BOOMBURST', type: 'sound', cat: 'special', power: 140, acc: 100, pp: 5, recoil: 0.25, fx: 'wave',
    desc: 'A deafening blast. It also hurts the user.' },
  ...
  rockslide: { name: 'ROCK SLIDE', type: 'rock', cat: 'physical', power: 75, acc: 90, pp: 10, flinch: 30, fx: 'rock',
    desc: 'Hurls large boulders. May make the foe flinch.' },
  ...
  bugbuzz: { name: 'BUG BUZZ', type: 'bug', cat: 'special', power: 90, acc: 100, pp: 10, fx: 'sound',
    stat: { target: 'foe', stat: 'spd', stages: -1, chance: 10 }, desc: 'A damaging buzz of wings. May lower SP. DEF.' },
  earthpower: { name: 'EARTH POWER', type: 'ground', cat: 'special', power: 90, acc: 100, pp: 10, fx: 'quake',
    stat: { target: 'foe', stat: 'spd', stages: -1, chance: 10 }, desc: 'The ground erupts. May lower the foe\'s SP. DEF.' },
  ...
  // Ice
  powdersnow: { name: 'POWDER SNOW', type: 'ice', cat: 'special', power: 40, acc: 100, pp: 25, fx: 'ice',
    desc: 'Blasts the foe with a flurry of powdery snow.' },
  iceshard: { name: 'ICE SHARD', type: 'ice', cat: 'physical', power: 40, acc: 100, pp: 30, priority: 1, fx: 'ice',
    desc: 'Hurls chunks of ice that always strike first.' },
  icywind: { name: 'ICY WIND', type: 'ice', cat: 'special', power: 55, acc: 95, pp: 15, fx: 'ice',
    stat: { target: 'foe', stat: 'spe', stages: -1 }, desc: 'A chilling wind that lowers the foe\'s SPEED.' },
  icefang: { name: 'ICE FANG', type: 'ice', cat: 'physical', power: 65, acc: 95, pp: 15, flinch: 10, fx: 'bite',
    desc: 'Bites with icy fangs. May make the foe flinch.' },
  aurorabeam: { name: 'AURORA BEAM', type: 'ice', cat: 'special', power: 65, acc: 100, pp: 20, fx: 'ice',
    stat: { target: 'foe', stat: 'atk', stages: -1, chance: 10 }, desc: 'A rainbow beam. May lower the foe\'s ATTACK.' },
  icebeam: { name: 'ICE BEAM', type: 'ice', cat: 'special', power: 90, acc: 100, pp: 10, fx: 'ice',
    desc: 'Fires a freezing beam of ice at the foe.' },
  iciclecrash: { name: 'ICICLE CRASH', type: 'ice', cat: 'physical', power: 85, acc: 90, pp: 10, flinch: 30, fx: 'ice',
    desc: 'Drops huge icicles on the foe. May cause flinching.' },
  blizzard: { name: 'BLIZZARD', type: 'ice', cat: 'special', power: 110, acc: 70, pp: 5, fx: 'ice',
    desc: 'Buries the foe in a howling snowstorm.' },
};
...
const TMS = {
  ...
  tm03: { move: 'waterpulse', compat: ['water', 'normal', 'ground', 'fighting', 'sound', 'ice'] },
