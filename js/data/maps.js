...
const MAPS = {
  ...
  archford: {
    ...
    npcs: [
      ...
      { id: 'af_plow', person: 'worker', x: 11, y: 2, dir: 'down', move: 'still', hideIf: 'badge_spark',
        text: 'The road north to STONEPEAK WOODS is snowed under. We\'re digging, but the snow keeps coming!\fCome back later. Much later, maybe.' },
      { id: 'af_plowblock', prop: 'barrier', x: 12, y: 2, move: 'still', hideIf: 'badge_spark',
        text: 'ROAD CLOSED\nSnow on ROUTE 11. -ARCHFORD ROAD CREW' },
  ...
  route3: {
    ...
    signs: [
      ...
      { x: 31, y: 11, text: 'ROUTE 12\nSouth: MEADOWFIELD FARM' },
    ],
    npcs: [
      ...
      { id: 'r3_farmhand', person: 'farmer', x: 32, y: 17, dir: 'up', move: 'still', hideIf: 'badge_dune',
        text: 'Sorry! The farm road\'s shut while we mend the fences. The MOOZLE broke out again.\fMEADOWFIELD FARM\'s down this way, once we\'ve rounded them all up.' },
